      ...
      <div class="bg-white p-10 rounded-[16px] shadow-lg w-full max-w-[400px] text-center" style="padding: 40px">
        ...
        <form @submit.prevent="login">
          <div class="mb-5 text-left">
            ...
            <input type="email" id="usuario" v-model="email" placeholder="Ingrese su usuario"
              class="input-usuario" />
          </div>

          <div class="mb-5 text-left">
            <label for="clave">Clave</label>
            <input type="password" id="clave" v-model="password" placeholder="Ingrese su clave" class="input-usuario "/>
          </div>
...
<style scoped>
  ...
  .input-usuario:hover {
  border-color: #007bff; /* Ejemplo: cambia el color del borde */
  background-color: #f0f8ff; /* Ejemplo: cambia el fondo */
  ...
  box-shadow: 0 0 0 2px rgba(0, 123, 255, 0.25); /* opcional: efecto sutil */
}
